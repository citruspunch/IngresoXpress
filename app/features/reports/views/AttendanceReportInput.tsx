...
type AttendancePermissionFormData = {
  employee_id: string,
  date_range: string,
}
...
const AttendanceReportInput = ({
  ...
  const onSubmit = async (values: z.infer<typeof reportInputFormSchema>) => {
    // console.log('DATE', JSON.stringify(values.date_range))
    setIsLoading(true)
    await navigate(`${appRoute.reports}/${values.employee_id}/${JSON.stringify(values.date_range)}`)
    setIsLoading(false)
  }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid gap-2 w-full">
                  <FormLabel htmlFor="employee">Nombre del Empleado</FormLabel>
                  {!employees && (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    Selecciona el intervalo de fechas en las que quieres generar
                    el reporte.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
